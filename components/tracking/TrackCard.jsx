...
export default function TrackCard({
  ...
  const [isLiked, setIsLiked] = useState(track.user_liked || track.userLiked || false);
  const [likesCount, setLikesCount] = useState(track.likes_count ?? track.likesCount ?? 0);
        ...
        {showActions && (
          <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-700 flex items-center gap-4">
            ...
            >
              ...
              <span>{track.comments_count ?? track.commentsCount ?? 0}</span>
            </button>

...
/**
 * Creates a Supabase client with a user's access token
 * This allows RPC calls to use auth.uid() properly
...
export const createAuthenticatedClient = (accessToken) => {
  ...
  return createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
    ...
    global: {
      headers: {
        'x-client-info': 'parklookup-server-auth',
 ...
 * Note: This is an alias for createServerClient for compatibility
 * @returns {import('@supabase/supabase-js').SupabaseClient} Supabase client instance
 */
export const createBrowserClient = () => {
  ...
  return createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
    ...
    global: {
      headers: {
        'x-client-info': 'parklookup-browser',
      },
    },
  });
};

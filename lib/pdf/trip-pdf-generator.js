 ...
 * - No external font files required (uses embedded standard fonts)
...
export const generateTripPdf = async (trip) => {
  ...
  // Trip details
  const detailsText = `${data.origin} • ${data.startDate} - ${data.endDate}`;

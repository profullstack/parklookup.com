 ...
 * @returns {Promise<Object>} Update result
 */
export const markAsVisited = async (accessToken, favoriteId, visitedAt = new Date().toISOString()) => updateFavorite(accessToken, favoriteId, {
    visited: true,
    visitedAt,
  });
 ...
 * @returns {Promise<Object>} Update result
 */
export const markAsNotVisited = async (accessToken, favoriteId) => updateFavorite(accessToken, favoriteId, {
    visited: false,
    visitedAt: null,
  });

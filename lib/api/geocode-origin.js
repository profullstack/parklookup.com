 ...
 * @returns {boolean} True if valid
 */
export const isValidLongitude = (lng) => typeof lng === 'number' && !isNaN(lng) && lng >= -180 && lng <= 180;
 ...
 * @returns {boolean} True if valid
 */
export const isValidCoordinates = (coords) => coords && isValidLatitude(coords.lat) && isValidLongitude(coords.lng);

-- Migration: Update get_user_feed function to include username
-- This allows the feed to link to user profiles by username
...
COMMENT ON FUNCTION get_user_feed IS 'Get personalized feed for a user showing media from followed users, now includes username for profile links';